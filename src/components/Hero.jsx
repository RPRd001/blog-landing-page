	...
	return (
		<div className="bg-gradient-to-r to-[#ff4457] from-[#ff886f] py-20 h-[500px] max-h-[500px] rounded-bl-[6rem] flex flex-col items-center justify-center gap-8 w-full">
			...
			<div className="flex flex-row items-center gap-3">
				<button className="border rounded-full py-1.5 px-3 bg-[#fdfefe] text-[#d35c6e]">Start for Free</button>
				<button className="border rounded-full py-1.5 px-3 bg-transparent text-white">Learn More</button>
			</div>
		</div>
	);
};
